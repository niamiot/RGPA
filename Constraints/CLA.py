...
class CLA(object):
	...
	erronous : list
		fills with number constraint which are not compatible.
		
	:Methods:

	info(self)
	rescale(self,f_vcw,cid=None)
	annulus_bound(self,cid=None)
	append(self,c)
	setvcw(self,vcw):
	merge2(self,vcw_init=1.0)
	valid_v(self,lv,N)
	refine(self,l,NBOXMAX=100,VOLMIN=0.1)
	show3(self,l=-1,amb=False,sc='all')
	prob(self,c,d)
	gapdetect(self,l,dlindx)
	min_dist(self,a,b)
	estpos2(self,l=-1,amb=False)
	"""
#	MEMBERS
...
#	List of elementary Constraints 
	...
	def refine(self,l,NBOXMAX=100,VOLMIN=0.01):
